/*
 * javaEE 개발패턴 중 mvc 패턴을 적용한 개발방법을 가리켜, model2방식이라 일컫는다
...
public class ListServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//뭔가 저장할 방법?
		//세션? 클라이언트가 브라우저 프로세스를 닫지 않거나 일정 시간내에 재접속할 떄 서버측의 메모리에 
		//담겨진 정보를 사용할 수 있는 기술(새로운 접속인 경우 세션객체를 새로 생성되고, 세션아이디가 새로 발급됨)
