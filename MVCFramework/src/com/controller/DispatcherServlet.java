 ...
 * 이때, 너무 많은 매핑은 관리하기가 까다롭다  따라서, 유지보수성이 떨어진자 
 * 현실과 유사하게, 어플리케이션에서도 대형 업무 처리시 클라이언트의 요청을 곧바로 해당 컨트롤러에게 
 * 처리하게 하지않고, 중간에 메인 컨트롤러를 두고, 모든 요청을 이 메인 컨트롤러에서 처리하여
...
public class DispatcherServlet extends HttpServlet {
	...
	//서블릿의 생명주기 메서드 중 서블릿이 소멸할 때 호출되는 메서드인 destroy()에 
