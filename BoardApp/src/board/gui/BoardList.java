...
public class BoardList extends Page{
	...
	BoardModel model;
	NoticeDAO noticeDAO;
	ArrayList<Notice> boardList; //추후 사용할 일이 있을 때를 대비
	
	public BoardList(BoardMain boardMain) {
		super(boardMain);
	
		//생성
		table = new JTable(model = new BoardModel());//jtable과 모델객체와의 연결
		...
		table.addMouseListener(new MouseAdapter() {
			public void mouseReleased(MouseEvent e) {
				...
				boardMain.showPage(Pages.valueOf("BoardContent").ordinal()); //페이지 이동만
